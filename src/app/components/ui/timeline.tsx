   ...
   const data = [
      {
         ...
         content: (
            <div>
               <div className="flex">
                  <div className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 w-[50%] pl-0 p-2  flex items-center">
                     At CVtoSalary.io, we make the process simple and secure.
                     Start by exploring our range of services tailored to meet
                     your career needs. Once you’ve selected the service that
               ...
               <div className="flex">
                  ...
                  <div className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 w-[50%] pr-0 p-2 flex items-center">
